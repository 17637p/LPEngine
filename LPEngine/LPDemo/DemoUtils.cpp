...
void lp::utils::Strafe(lp::common::Transform& cameraTransform, float distance)
{
...
void lp::utils::Walk(lp::common::Transform& cameraTransform, float distance)
{
	DirectX::SimpleMath::Matrix tempMatrix;
	tempMatrix = DirectX::SimpleMath::Matrix::CreateFromQuaternion(cameraTransform.worldRotation);
...
void lp::utils::WorldUpdown(lp::common::Transform& cameraTransform, float distance)
{
	DirectX::SimpleMath::Matrix tempMatrix;
	tempMatrix = DirectX::SimpleMath::Matrix::CreateFromQuaternion(cameraTransform.worldRotation);
...
void lp::utils::Yaw(lp::common::Transform& cameraTransform, float angle)
{
...
void lp::utils::Pitch(lp::common::Transform& cameraTransform, float angle)
{
